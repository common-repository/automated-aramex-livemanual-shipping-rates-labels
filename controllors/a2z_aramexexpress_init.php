			...
			foreach ($custom_settings as $key => $value) {
				...
				if (isset($general_settings['a2z_aramexexpress_carrier']) && !empty($general_settings['a2z_aramexexpress_carrier'])) {
					foreach ($general_settings['a2z_aramexexpress_carrier'] as $carrier => $carriername) {
						$product_type = (($dutiable == "DOM")) ? "OND" : $carrier;
...
?>
			...
			<div class="card">
				<div class="content">
					...
					<h2><strong>Shipi + ARAMEX Express</strong></h2>
					<p style="font-size: 14px;line-height: 27px;">
						<?php _e('Welcome to Shipi! You are at just one-step ahead to configure the ARAMEX Express with Shipi.', 'a2z_aramexexpress') ?><br>
