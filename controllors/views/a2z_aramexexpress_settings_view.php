...
$pickup_type = array('S' => 'S-SameDayPickup','A' => 'A-AdvancedPickup');
	...
	{	
		...
		if(isset($_POST['a2z_aramexexpress_site_id'])){
			...
			$general_settings['a2z_aramexexpress_test'] = sanitize_text_field('no');
...
<fieldset <?php echo ($initial_setup) ? 'style="display:none"' : ''?>>
 ...
 <?php
  ...
  <fieldset>
	...
	<img src="<?php echo plugin_dir_url(__FILE__); ?>aramex_logo.png">
	<h3 class="fs-subtitle"><?php __("Shipi performs all the operations in its own server. So it won't affect your page speed or server usage.", "a2z_aramexexpress") ?></h3>
	<tr><td style="padding:10px;"><hr></td></tr>
	<?php 
		if(!isset($general_settings['a2z_aramexexpress_integration_key']) || empty($general_settings['a2z_aramexexpress_integration_key'])){
		?>
			<input type="radio" name="shipo_link_type" value="WITHOUT" checked>I don't have Shipi account  &nbsp; &nbsp; &nbsp;
			<input type="radio" name="shipo_link_type" value="WITH">I have Shipi integration key
		<br>
	...
	<?php }else{
		...
		<?php __("It's great to have you here. Your account has been linked successfully with Shipi.", "a2z_aramexexpress") ?> <br><br>
